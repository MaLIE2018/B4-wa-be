...
io.on("connect", function (socket) {
    ...
    socket.on("joinRooms", function (rooms) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            rooms.forEach(function (room) { return socket.join(room); });
            return [2 /*return*/];
        });
    }); });
    socket.on("connect", function (userId) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userSchema_1.default.findOneAndUpdate({ _id: userId }, { online: true })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    socket.on("sendMessage", function (message, chatId) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, chatSchema_1.default.findOneAndUpdate({ _id: chatId }, {
    ...
    socket.on("disconnect", function (userId) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userSchema_1.default.findOneAndUpdate({ _id: userId }, { online: false })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
