...
var JWTMiddleWare = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var content, user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!req.cookies.access_token) return [3 /*break*/, 1];
                next(http_errors_1.default(401, { message: "Provide Access Token" }));
                return [3 /*break*/, 5];
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, tools_1.verifyAccessToken(req.cookies.access_token)];
            case 2:
                content = _a.sent();
                return [4 /*yield*/, userSchema_1.default.findById(content._id)];
            case 3:
                user = _a.sent();
                if (user) {
                    req.user = user;
...
var basicAuthMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var decoded, _a, email, password, user;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [3 /*break*/, 3];
            case 1:
                decoded = atob_1.default(req.headers.authorization.split(" ")[1]);
                _a = decoded.split(":"), email = _a[0], password = _a[1];
                return [4 /*yield*/, userSchema_1.default.checkCredentials(email, password)];
            case 2:
                user = _b.sent();
                if (user) {
                    req.user = user;
